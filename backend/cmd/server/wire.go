...
func provideCleanup(
	...
	openAIRateLimitRevalidation *service.OpenAIRateLimitRevalidationService,
	...
	return func() {
		...
		parallelSteps := []cleanupStep{
			{"OpenAIRateLimitRevalidationService", func() error {
				if openAIRateLimitRevalidation != nil {
					openAIRateLimitRevalidation.Stop()
				}
				return nil
			}},
