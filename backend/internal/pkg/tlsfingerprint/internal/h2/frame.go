...
import (
	...
	"github.com/Wei-Shaw/sub2api/internal/pkg/tlsfingerprint/internal/h2/httpsfv"
...
func (fr *Framer) maxHeaderListSize() uint32 {
	if fr.exactHeaderListSize != nil {
		return *fr.exactHeaderListSize
	}
