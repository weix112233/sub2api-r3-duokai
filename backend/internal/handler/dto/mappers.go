...
func AccountFromServiceShallow(a *service.Account) *Account {
	...
	// TLS fingerprinting also applies to OpenAI OAuth accounts. Always expose
	// an explicit boolean for eligible accounts so edit forms can distinguish
	// a persisted opt-out from a field omitted by an older mapper.
