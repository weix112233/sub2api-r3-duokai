...
// is immediately before native_compaction_v2; reasoning_tokens follows it and
...
func TestPrepareUsageLogInsert_SessionIDArgWiring(t *testing.T) {
	...
	// created_at is last; reasoning_tokens is before it; native_compaction_v2
	// precedes reasoning_tokens; session_id precedes native_compaction_v2.
	...
	require.Equal(t, "integer", usageLogInsertArgTypes[len(usageLogInsertArgTypes)-2],
		"reasoning_tokens arg type must be integer")
}
